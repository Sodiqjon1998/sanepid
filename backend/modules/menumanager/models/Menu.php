...
class Menu extends \kartik\tree\models\Tree
{
    ...
    public function getUrl($params = [])
    {
        ...
        if ($model->url_type === 'interactive_services') $menuParams = ['news/news', 'id' => $model->url_value];
        if ($model->url_type === 'document') $menuParams = ['document/document', 'id' => $model->url_value];
        if ($model->url_type === 'c-action') $menuParams = [$model->url_value];
        if ($model->url_type === 'leader') $menuParams = ['leader/index', 'id' => $model->url_value];
        ...
        if ($model->url_type === 'departments') $menuParams = ['region/region', 'id' => $model->url_value];

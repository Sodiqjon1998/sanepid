    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4">
            <?= $form->field($node, 'url_type')->dropDownList([
                ...
                // 'main' => "Bosh sahifa",
                 'document' => "Xujjat tuzilmasini tanlang",
                'interactive_services' => "Yangiliklar kategorysi",
                'page' => "Sahifalar",
                'leader' => "Rahbariyat",
//                'privatization' => "Xususiylashtirish",
                'organization' => "Tashkilotlar",
                'departments' => "Xudud kategoriylari",
//                'c-action' => "Sayt bo'limlari",
                'other' => "Boshqa",
                   ...
                   var t =  $(this).val()
                    ...
                    else if (t === "document" || t === "leader" || t === "departments"|| t === "organization" || t === "interactive_services"  || t === "departments" ||  t === "page"|| t === "faculty"|| t == "catalog" || t == "sub_catalog" || t == "c-action"){
                        $.ajax({
                            url: menu_url,
                            data: {type:t},
                            type: "get",
        ...
        <div class="col-sm-12 col-md-8">
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    <?php
                    if ($node->url_type == 'page')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(Pages::find()->all(), 'id', 'title'))->label(false);
                    ...
                    elseif ($node->url_type == 'leader')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\common\models\LeaderCategory::find()->all(), 'id', 'title'))->label(false);
                    elseif ($node->url_type == 'departments')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(RegionCategory::find()->all(), 'id', 'title'))->label(false);
                    elseif ($node->url_type == 'document')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(DocumentCategory::find()->all(), 'id', 'title'))->label(false);
                    elseif ($node->url_type == 'organization')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\OrganizationCategory::find()->all(), 'slug', 'title'))->label(false);

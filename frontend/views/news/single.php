...
<div class="batafsil-page">
    <div class="my-container">
        <div class="batafsil-in">
            <div class="main">
                <div class="main-left">
                    <p class="top-t txt-20">Matbuot xizmatlari <span>> <?=$newOne->category->title;?></span></p>
                    <p class="sana ">
                    ...
                    <img src="<?= $newOne->imageUrl;?>" alt="" class="img">
                    <h1 class="txt-48">
                        <?=$newOne->title;?>
                    </h1>
                    <p class="txt-24">

    ...
    <div class="batafsil-page">
        <div class="my-container">
            <div class="batafsil-in">
                <div class="main">
                    <div class="main-left">
                        <p class="top-t txt-20"><?=Yii::t('app','service');?></p>
                        <p class="sana ">
                        ...
                        <img src="<?=$newsOne->getImageUrl();?>" alt="" class="img">
                        <h1 class="txt-48">
                            <?=$newsOne->title;?>
                        </h1>
                        <p class="txt-24">
    ...
    <div class="batafsil-page">
        <div class="my-container">
            <div class="batafsil-in">
                <div class="main">
                    <div class="main-left">
                        <p class="top-t txt-20"><?=Yii::t('app','service');?> <span>> <?=Yii::t('app', 'news');?></span></p>
                        <p class="sana ">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <img src="<?=$region->getImageUrl();?>" alt="" class="img">
                        <h1 class="txt-48">
                            <?=$region->title;?>
                        </h1>
                        <p class="txt-24">
                    ...
                    <?=$this->render('@frontend/views/news/otherNews');?>
                </div>
            </div>
        </div>
    </div>

<?php elseif (isset($document)): ?>
...
<?php else: ?>
    ...
    <div class="main-content " style="height: 30vh;">
        <div class="swiper-gallery swiper my-swww">
            <h3 class="alert-warning p-5 text-center m-5">Ma'lumotlar topilmadi</h3>
        </div>
    </div>

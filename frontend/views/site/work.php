...
/* @var $vacanies \common\models\Work */
...
<div class="work-main">
    <div class="my-container">
        <div class="work-in">
            <p class="top-t txt-20"><?=Yii::t('app', 'organization_about');?>  <span> >  <?=Yii::t('app', 'works');?></span></p>
            <h1 class="txt-48">
                <?=Yii::t('app', 'works');?>
            </h1>
            <?php foreach ($vacanies as $vacany):?>
                <div class="card-w">
                    <div class="card-w-in">
                        <h1 class="left txt-18">Nomi</h1>
                        <p class="right txt-20">
                            <?=$vacany->name;?>
                        </p>
                    </div>
                    <div class="card-w-in">
                        <h1 class="left txt-18">Tashkilot</h1>
                        <p class="right txt-20">
                            <?=$vacany->organ;?>
                        </p>
                    </div>
                    <div class="card-w-in">
                        <h1 class="left txt-18">Bo’lim</h1>
                        <p class="right txt-20">
                            <?=$vacany->section;?>
                        </p>
                    </div>
                    <div class="card-w-in">
                        <h1 class="left txt-18">Chop etilgan sana</h1>
                        <p class="sana ">
                    ...
                    <div class="card-w-in">
                        <h1 class="left txt-18">Mutahassislik</h1>
                        <p class="right txt-20">
                            <?=$vacany->spec;?>
                        </p>
                    </div>
                    <div class="card-w-in">
                        <h1 class="left txt-18"><?=Yii::t('app', 'connect');?></h1>
                        <a href="<?= Url::to(['site/contact']);?>" class="glavni-btn txt-18">
                            <?=Yii::t('app', 'connect');?>
                        </a>
                    </div>
                </div>
